 ...
 */}const e="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,n=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}},i=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${i}--\x3e`,r=new RegExp(`${i}|${s}`);class o{constructor(t,e){this.parts=[],this.element=e;const n=[],s=[],o=document.createTreeWalker(e.content,133,null,!1);let l=0,u=-1,h=0;const{strings:p,values:{length:m}}=t;for(;h<m;){const t=o.nextNode();if(null!==t){if(u++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:n}=e;let i=0;for(let t=0;t<n;t++)a(e[t].name,"$lit$")&&i++;for(;i-- >0;){const e=p[h],n=c.exec(e)[2],i=n.toLowerCase()+"$lit$",s=t.getAttribute(i);t.removeAttribute(i);const o=s.split(r);this.parts.push({type:"attribute",index:u,name:n,strings:o}),h+=o.length-1}}"TEMPLATE"===t.tagName&&(s.push(t),o.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(i)>=0){const i=t.parentNode,s=e.split(r),o=s.length-1;for(let e=0;e<o;e++){let n,r=s[e];if(""===r)n=d();else{const t=c.exec(r);null!==t&&a(t[2],"$lit$")&&(r=r.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),n=document.createTextNode(r)}i.insertBefore(n,t),this.parts.push({type:"node",index:++u})}""===s[o]?(i.insertBefore(d(),t),n.push(t)):t.data=s[o],h+=o}}else if(8===t.nodeType)if(t.data===i){const e=t.parentNode;null!==t.previousSibling&&u!==l||(u++,e.insertBefore(d(),t)),l=u,this.parts.push({type:"node",index:u}),null===t.nextSibling?t.data="":(n.push(t),u--),h++}else{let e=-1;for(;-1!==(e=t.data.indexOf(i,e+1));)this.parts.push({type:"node",index:-1}),h++}}else o.currentNode=s.pop()}for(const t of n)t.parentNode.removeChild(t)}}const a=(t,e)=>{const n=t.length-e.length;return n>=0&&t.slice(n)===e},l=t=>-1!==t.index,d=()=>document.createComment(""),c=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function u(t,e){const{element:{content:n},parts:i}=t,s=document.createTreeWalker(n,133,null,!1);let r=p(i),o=i[r],a=-1,l=0;const d=[];let c=null;for(;s.nextNode();){a++;const t=s.currentNode;for(t.previousSibling===c&&(c=null),e.has(t)&&(d.push(t),null===c&&(c=t)),null!==c&&l++;void 0!==o&&o.index===a;)o.index=null!==c?-1:o.index-l,r=p(i,r),o=i[r]}d.forEach((t=>t.parentNode.removeChild(t)))}const h=t=>{let e=11===t.nodeType?0:1;const n=document.createTreeWalker(t,133,null,!1);for(;n.nextNode();)e++;return e},p=(t,e=-1)=>{for(let n=e+1;n<t.length;n++){const e=t[n];if(l(e))return n}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const v=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),S=` ${i} `;class w{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let r=0;r<t;r++){const t=this.strings[r],o=t.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===t.indexOf("--\x3e",o+1);const a=c.exec(t);e+=null===a?t+(n?S:s):t.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+i}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==v&&(e=v.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,i){const s=e[0];if("."===s){return new T(t,e.slice(1),n).parts}if("@"===s)return[new A(t,e.slice(1),i.eventContext)];if("?"===s)return[new M(t,e.slice(1),n)];return new x(t,e,n).parts}handleTextExpression(t){return new N(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const tt={};class et extends W{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,n)=>t.reduceRight(((t,n)=>Array.isArray(n)?e(n,t):(t.add(n),t)),n),n=e(t,new Set),i=[];n.forEach((t=>i.unshift(t))),this._styles=i}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!K){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new Q(String(e),G)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==tt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return tt}}et.finalized=!0,et.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const s=i.scopeName,r=R.has(e),o=j&&11===e.nodeType&&!!e.host,a=o&&!F.has(s),l=a?document.createDocumentFragment():e;if(((t,e,i)=>{let s=R.get(e);void 0===s&&(n(e,e.firstChild),R.set(e,s=new N(Object.assign({templateFactory:V},i))),s.appendInto(e)),s.setValue(t),s.commit()})(t,l,Object.assign({templateFactory:I(s)},i)),a){const t=R.get(l);R.delete(l);const i=t.value instanceof y?t.value.template:void 0;$(s,l,i),n(e,e.firstChild),e.appendChild(l),R.set(e,t)}!r&&o&&window.ShadyCSS.styleElement(e.host)};
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const nt=new WeakMap,it=(st=t=>e=>{const n=nt.get(e);if(void 0===t&&e instanceof P){if(void 0!==n||!nt.has(e)){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else t!==n&&e.setValue(t);nt.set(e,t)},(...t)=>{const e=st(...t);return m.set(e,!0),e});var st,rt=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,ot="[^\\s]+",at=/\[([^]*?)\]/gm;function lt(t,e){for(var n=[],i=0,s=t.length;i<s;i++)n.push(t[i].substr(0,e));return n}var dt=function(t){return function(e,n){var i=n[t].map((function(t){return t.toLowerCase()})),s=i.indexOf(e.toLowerCase());return s>-1?s:null}};function ct(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];for(var i=0,s=e;i<s.length;i++){var r=s[i];for(var o in r)t[o]=r[o]}return t}var ut=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ht=["January","February","March","April","May","June","July","August","September","October","November","December"],pt=lt(ht,3),mt={dayNamesShort:lt(ut,3),dayNames:ut,monthNamesShort:pt,monthNames:ht,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},ft=ct({},mt),gt=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},_t={D:function(t){return String(t.getDate())},DD:function(t){return gt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return gt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return gt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return gt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return gt(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return gt(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return gt(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return gt(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return gt(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return gt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return gt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+gt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+gt(Math.floor(Math.abs(e)/60),2)+":"+gt(Math.abs(e)%60,2)}},yt=function(t){return+t-1},vt=[null,"[1-9]\\d?"],St=[null,ot],wt=["isPm",ot,function(t,e){var n=t.toLowerCase();return n===e.amPm[0]?0:n===e.amPm[1]?1:null}],bt=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var n=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?n:-n}return 0}],Ct=(dt("monthNamesShort"),dt("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var xt=function(t,e,n){if(void 0===e&&(e=Ct.default),void 0===n&&(n={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var i=[];e=(e=Ct[e]||e).replace(at,(function(t,e){return i.push(e),"@@@"}));var s=ct(ct({},ft),n);return(e=e.replace(rt,(function(e){return _t[e](t,s)}))).replace(/@@@/g,(function(){return i.shift()}))},Pt=(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}(),new Set(["call-service","divider","section","weblink","cast","select"])),Nt={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},Mt=function(t,e){void 0===e&&(e=!1);var n=function(t,e){return i("hui-error-card",{type:"error",error:t,config:e})},i=function(t,e){var i=window.document.createElement(t);try{i.setConfig(e)}catch(i){return console.error(t,i),n(i.message,e)}return i};if(!t||"object"!=typeof t||!e&&!t.type)return n("No type defined",t);var s=t.type;if(s&&s.startsWith("custom:"))s=s.substr("custom:".length);else if(e)if(Pt.has(s))s="hui-"+s+"-row";else{if(!t.entity)return n("Invalid config given.",t);var r=t.entity.split(".",1)[0];s="hui-"+(Nt[r]||"text")+"-entity-row"}else s="hui-"+s+"-card";if(customElements.get(s))return i(s,t);var o=n("Custom element doesn't exist: "+t.type+".",t);o.style.display="None";var a=setTimeout((function(){o.style.display=""}),2e3);return customElements.whenDefined(t.type).then((function(){clearTimeout(a),function(t,e,n,i){i=i||{},n=null==n?{}:n;var s=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});s.detail=n,t.dispatchEvent(s)}(o,"ll-rebuild",{},o)})),o};console.info("%c STACK-IN-CARD \n%c   Version 0.2.3   ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const Tt=window.loadCardHelpers?window.loadCardHelpers():void 0;let kt=class extends et{set hass(t){this._hass=t,this._card&&(this._card.hass=t)}static get styles(){return X`
      ha-card {
        overflow: visible;
      }
    `}setConfig(t){var e,n;if(!t.cards)throw new Error("There is no cards parameter defined");this._config=Object.assign(Object.assign({mode:"vertical"},t),{keep:Object.assign({background:!1,margin:!1,box_shadow:!1,border_radius:!1,border:!1},t.keep)}),(null===(e=this._config.keep)||void 0===e?void 0:e.margin)&&void 0===(null===(n=this._config.keep)||void 0===n?void 0:n.outer_padding)&&(this._config.keep.outer_padding=!0),this._createStack()}updated(t){super.updated(t),this._card&&(this._waitForChildren(this._card,!1),window.setTimeout((()=>{var t,e,n,i,s;if((null===(e=null===(t=this._config)||void 0===t?void 0:t.keep)||void 0===e?void 0:e.background)||this._waitForChildren(this._card,!0),(null===(i=null===(n=this._config)||void 0===n?void 0:n.keep)||void 0===i?void 0:i.outer_padding)&&(null===(s=this._card)||void 0===s?void 0:s.shadowRoot)){const t=this._card.shadowRoot.getElementById("root");t&&(t.style.padding="8px")}}),500))}async _createStack(){this._cardPromise=this._createCard({type:`${this._config.mode}-stack`,cards:this._config.cards}),this._card=await this._cardPromise}render(){return this._hass&&this._config?U`
      <ha-card header=${it(this._config.title)}>
        <div>${this._card}</div>
      </ha-card>
    `:U``}_updateStyle(t,e){var n,i,s,r,o,a,l,d;t&&((null===(i=null===(n=this._config)||void 0===n?void 0:n.keep)||void 0===i?void 0:i.box_shadow)||(t.style.boxShadow="none"),(null===(r=null===(s=this._config)||void 0===s?void 0:s.keep)||void 0===r?void 0:r.border)||"true"===getComputedStyle(t).getPropertyValue("--keep-border").trim()||(t.style.border="none"),!(null===(a=null===(o=this._config)||void 0===o?void 0:o.keep)||void 0===a?void 0:a.background)&&e&&"true"!==getComputedStyle(t).getPropertyValue("--keep-background").trim()&&(t.style.background="transparent"),(null===(d=null===(l=this._config)||void 0===l?void 0:l.keep)||void 0===d?void 0:d.border_radius)||(t.style.borderRadius="0"))}_loopChildren(t,e){t.childNodes.forEach((t=>{var n,i;"STACK-IN-CARD"!==t.tagName&&(!(null===(i=null===(n=this._config)||void 0===n?void 0:n.keep)||void 0===i?void 0:i.margin)&&t.style&&(t.style.margin="0px"),this._waitForChildren(t,e))}))}_updateChildren(t,e){if(t)if(t.shadowRoot){const n=t.shadowRoot.querySelector("ha-card");if(n)this._updateStyle(n,e);else{const n=t.shadowRoot.getElementById("root")||t.shadowRoot.getElementById("card");if(!n)return;n.setAttribute("style","gap:var(--vertical-stack-card-gap,var(--stack-card-gap,0px)) !important"),this._loopChildren(n,e)}}else"function"==typeof t.querySelector&&t.querySelector("ha-card")&&this._updateStyle(t.querySelector("ha-card"),e),this._loopChildren(t,e)}_waitForChildren(t,e){t.updateComplete?t.updateComplete.then((()=>{this._updateChildren(t,e)})):this._updateChildren(t,e)}async _createCard(t){let e;return e=Tt?(await Tt).createCardElement(t):Mt(t),this._hass&&(e.hass=this._hass),e&&e.addEventListener("ll-rebuild",(n=>{n.stopPropagation(),this._rebuildCard(e,t)}),{once:!0}),e}async _rebuildCard(t,e){const n=await this._createCard(e);return t.replaceWith(n),this._card=n,window.setTimeout((()=>{var t,e,n,i,s;if((null===(e=null===(t=this._config)||void 0===t?void 0:t.keep)||void 0===e?void 0:e.background)||this._waitForChildren(this._card,!0),(null===(i=null===(n=this._config)||void 0===n?void 0:n.keep)||void 0===i?void 0:i.outer_padding)&&(null===(s=this._card)||void 0===s?void 0:s.shadowRoot)){const t=this._card.shadowRoot.getElementById("root");t&&(t.style.padding="8px")}}),500),n}async getCardSize(){return await this._cardPromise,this._card?await this._computeCardSize(this._card):0}_computeCardSize(t){return"function"==typeof t.getCardSize?t.getCardSize():customElements.get(t.localName)?1:customElements.whenDefined(t.localName).then((()=>this._computeCardSize(t)))}};var Et;t([Z()],kt.prototype,"_card",void 0),t([Z()],kt.prototype,"_config",void 0),kt=t([(Et="stack-in-card",t=>"function"==typeof t?((t,e)=>(window.customElements.define(t,e),e))(Et,t):((t,e)=>{const{kind:n,elements:i}=e;return{kind:n,elements:i,finisher(e){window.customElements.define(t,e)}}})(Et,t))],kt);
